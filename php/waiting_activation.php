...
<html lang="en">
  ...
  <head>
    ...
    <title>Αναμονή Ενεργοποίησης</title>
    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-lg-12 well">
                <h3 align=left><p>&nbsp;&nbsp;&nbsp;&nbsp;Ο λογαριασμός αυτός δεν έχει ενεργοποιηθεί από τον διαχειριστή.
				Αν ο λογαριασμός είναι νέος τότε απλά περιμένετε τον διαχειριστή να ενεργοποιήσει τον λογαριασμό σας.Μέχρι τότε συνεχίστε την αναζήτηση δραστηριοτήτων πατώντας το κουμπί "Αρχική" στο μενού.</p>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;Αν ο λογαριασμός είχε ήδη ενεργοποιηθεί παλαιότερα και
				τώρα δεν μπορείτε να εισέλθετε ενώ δώσατε τα σωστά διαπιστευτήρια τότε ο λογαριασμός αυτός έχει απενεργοποιηθεί από τον διαχειριστή.</p>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;Για περισσότερες πληροφορίες στείλτε e-mail στο admin_kidsup@gmail.com ή καλέστε στο 2101212789</p></h3>
            </div>
        </div>
    </div>
    <!-- Footer -->
